...
1. **[RunInference](#1-RunInference)** - Managed online prediction service
2. **[ModelHandler (PyTorch/TF)](#2-modelhandler-pytorch)** - SQL-based inference in BigQuery
3. **[KeyedModelHandler](#3-keyedmodelhandler)** - SQL-based inference in PostgreSQL database
4. **[Event-Mode Hot-Swap](#4-evemt-mode-hot-swap)** - SQL-based inference in globally distributed database
5. **[PredictionResult](#5-predictionresult)** - Batch and streaming inference pipelines
